...
function initSocket(server) {
  ...
  // ⭐⭐⭐ FIX: Permitir WebSockets desde AWS S3, CloudFront o cualquier ORIGIN
  const io = new Server(server, {
    cors: {
      origin: "*",                   // ← Permite cualquier origen
      methods: ["GET", "POST"],
      credentials: false,            // ← No usas cookies en websockets
      allowedHeaders: ["Content-Type", "Authorization"]
    },
    transports: ["websocket", "polling"]  // ← Importante para AWS
  });
